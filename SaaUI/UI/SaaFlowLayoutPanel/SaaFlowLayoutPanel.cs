...
namespace SaaUI
{
    [ToolboxBitmap(typeof(SaaFlowLayoutPanel), "icons.SaaFlowLayoutPanel_16.bmp")]
    public class SaaFlowLayoutPanel : FlowLayoutPanel
    {
        public SaaFlowLayoutPanel()
        {
        ...
        Color _BackColor2 = Color.FromArgb(192, 19, 255);
        /// <summary>
