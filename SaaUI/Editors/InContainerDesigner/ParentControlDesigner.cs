...
namespace SaaUI
{
    ...
    internal class SaaDropDownParentControlDesigner : ParentControlDesigner
    {
        ...
        public override void Initialize(IComponent component)
        {
            ...
            var contentsPanel = ((SaaDropDownForm)this.Control).Content;
            this.EnableDesignMode(contentsPanel, "Content");

            //_adoner = new Adorner();
            //this.BehaviorService.Adorners.Add(_adoner);
            //_adoner.Glyphs.Add(new SaaAccordionGlyph(BehaviorService, ((SaaDropDownForm)this.Control).Head, this.Control));
        }
