...
namespace SaaUI
{
    public class CxFlatTextArea : Control
    {
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            if (_resizing)
            {
                ...
                this.Height = Height < 38 ? 38 : Height;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            g.DrawPath(new Pen(_baseTextBox.Focused ? ThemeColors.PrimaryColor : ThemeColors.OneLevelBorder, 0.5f), bg);
