...
namespace SaaUI
{
    ...
    public abstract class RAdapter
    {
        ...
        public RImage GetLoadingImage()
        {
            if (_loadImage == null)
            {
                var stream = typeof(HtmlRendererUtils).Assembly.GetManifestResourceStream("SaaUI.ImageLoad.png");
                if (stream != null)
        ...
        public RImage GetLoadingFailedImage()
        {
            if (_errorImage == null)
            {
                var stream = typeof(HtmlRendererUtils).Assembly.GetManifestResourceStream("SaaUI.ImageError.png");
                if (stream != null)
