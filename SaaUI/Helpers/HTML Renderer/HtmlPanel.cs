...
{
    /// <summary>
    /// Html & css supported Panel
    /// </summary>
   [ToolboxItem(true)]
    [ToolboxBitmap(typeof(SaaHtmlBox), "icons.SaaHtmlBox_16.bmp")]
    internal class SaaHtmlBox : ScrollableControl
    {
        ...
        /// <summary>
        /// Creates a panel and sets a basic css for it's styling.
        /// </summary>
        public SaaHtmlBox()
        {
            AutoScroll = true;
